<template>
    ...
    <div class="m-comment__contents">{{ content }}</div>
    <div class="a-label">{{ userSex|to_jp_gender }}{{userAge|to_jp_age}}</div>
    <LikeText />
    <div class="a-likes"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
